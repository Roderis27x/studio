    ...
    <section className="bg-white py-20 md:py-32">
      <div className="container mx-auto px-6 text-center">
        ...
        <div className="flex justify-center items-center">
          <a href="#products" className="flex items-center text-primary font-semibold text-lg group bg-slate-100 hover:bg-slate-200 px-8 py-4 rounded-lg transition-all duration-300">
            Saber Más
