  ...
  return (
    <section id="contact" className="bg-white py-20">
      <div className="container mx-auto px-6">
        <div className="bg-blue-600 text-white rounded-lg shadow-xl p-10 md:p-16 text-center">
          ...
          <a href="#" className="bg-white text-blue-600 px-8 py-4 rounded-lg font-semibold text-lg hover:bg-slate-100 transition-all duration-300 shadow-md transform hover:scale-105 inline-block">
